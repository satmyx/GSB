        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <form action="index.php?uc=suivrePaiement&action=FicheFraisSP" method="post" role="form">
                    <div class="form-group">
                        <select id="lstVisiteur" name="lstVisiteur" onchange="submit();" class="form-control">
                            <option value="Choix" selected>Choisir un visiteur</option>
                            <?php
                            foreach ($lesVisiteurs as $unVisiteur) {
                            ...
                            ?>
                                    <option selected value="<?php echo $selectedValue ?>">
                                        <?php echo $unVisiteur['nomvisiteur'] ?></option>
                                <?php
                                } else {
                                ?>
                                    <option value="<?php echo $id_vst ?>">
